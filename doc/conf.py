...
for ext in ("ipython_console_highlighting", "cython_highlighting", "sphinx_rtd_theme"):
    try:
...
project = "CLEED"
authors = ("Georg Held", "Liam Deacon")
copyright = "2014-{}, {} & collaborators".format(YEAR, ", ".join(authors))  # pylint: disable=redefined-builtin
...
latex_documents = [
    ("index", "CLEED.tex", "CLEED Documentation", "{} \\& collaborators".format(", ".join(authors)), "manual"),
]
...
man_pages = [("index", "cleed", "CLEED Documentation", ["{} & collaborators".format(", ".join(authors))], 1)]
...
texinfo_documents = [
    (
        ...
        "CLEED",
        "CLEED Documentation",
        "{} & collaborators".format(", ".join(authors)),
        "CLEED",
...
epub_title = "CLEED"
epub_author = "{} & collaborators".format(", ".join(authors))
epub_publisher = "{} & collaborators".format(", ".join(authors))
epub_copyright = "2014-{}, {} & collaborators".format(YEAR, ", ".join(authors))

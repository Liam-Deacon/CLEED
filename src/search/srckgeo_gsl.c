/***********************************************************************
 GH/01.04.03
  ...
  real sr_ckgeo_gsl(gsl vector *par)

 Check geometry

 Changes:

GH/24.08.1995  - Creation (copy from srevalrf.c)
SRP/01.04.2003 - Modified the code for the angle search (n_par_geo)
LD/01.07.2014  - Modified to use GNU Scientific Library structures.

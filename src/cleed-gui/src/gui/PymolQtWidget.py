...
class PymolQtWidget(QGLWidget):
    ...
    def __init__(self, parent, enableUi, File=""):
        ...
        self.pymol.cmd.do("zoom center, 1")
    ...
    def paintGL(self):
        ...
        bottom = self.mapToGlobal(
                              QtCore.QPoint(0, self.height())).y()
...
class PyMolWidgetDemo(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        try:
            widget = PymolQtWidget(self, True, 
                            r"C:\Users\Liam\Dropbox\Structures\bcc.xyz")
        except:
            widget = PymolQtWidget(self, True, 
                            r"C:\Users\kss07698\Dropbox\Structures\bcc.xyz")

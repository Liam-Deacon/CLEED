 ...
 *
 *
 * Description: function prototype declarations for the leed programs
 *              (sym and temp)
 *
 * Changes:
...
int leed_leed_inp_bul_layer(leed_cryst_t *, leed_atom *, real *);
int leed_leed_inp_bul_layer_sym(leed_cryst_t *, leed_atom *, real *);
real leed_inp_debye_temp(real , real , real );
int leed_inp_overlayer(leed_cryst_t *, leed_atom *);
int leed_inp_overlayer_sym(leed_cryst_t *, leed_atom *);
...
int leed_inp_leed_read_par(leed_var **, leed_energy **, leed_cryst_t *, char *);
   /* show all parameters; file linpshowbop.c */
int leed_inp_show_beam_op(leed_cryst_t *, leed_cryst_t *, leed_phs_t *);
   /* read and write parameters */
int leed_write_par(leed_cryst_t *, leed_phs_t *, leed_var *,
              leed_energy *, leed_beam_t *, FILE *);
int leed_read_par(leed_cryst_t **, leed_phs_t **, leed_var **,
             leed_energy **, leed_beam_t **, FILE *);
...
int leed_par_reset(leed_var *, leed_cryst_t *);

    /* update energy (lpcupdate.c) and tl (lpcmktl.c) */
int leed_par_update(leed_var *, leed_phs_t *, real);
int leed_par_update_nd(leed_var *, leed_phs_t *, real);
...
int leed_output_beam_list(leed_beam_t **, leed_beam_t *, leed_energy *, FILE *);
int leed_output_int(mat, leed_beam_t *, leed_beam_t *, leed_var *, FILE *);
int leed_output_iint_sym(mat, leed_beam_t *, leed_beam_t *, leed_var *, FILE *);
...
int leed_ld_2lay (mat *, mat *, mat *, mat *, 
             ...
             leed_beam_t *, real *);
mat leed_ld_2lay_rpm (mat, mat, mat, mat, mat, mat, leed_beam_t *, real *);
...
*********************************************************************/
   ...
   /* Don't know yet */
int leed_ms(mat *, mat *, leed_var *, leed_layer *, leed_beam_t *);
int leed_ms_nd(mat *, mat *, mat *, mat *,
               leed_var *, leed_layer *, leed_beam_t *);
int leed_ms_sym(mat *, mat *, leed_var *, leed_layer *, leed_beam_t *);
...
mat leed_ms_comp_k_sum(mat, leed_beam_t *, leed_atom *, int, int, int);
